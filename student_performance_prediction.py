...
rf_pred = rf_grid_search.best_estimator_.predict(X_selected_regression)

# Calculate accuracy
accuracy_rf = accuracy_score(Y_classification, rf_pred)

# Calculate precision
precision_rf = precision_score(Y_classification, rf_pred, average='weighted')

# Calculate recall
recall_rf = recall_score(Y_classification, rf_pred, average='weighted')

# Calculate F1 score
f1_rf = f1_score(Y_classification, rf_pred, average='weighted')
